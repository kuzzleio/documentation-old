    ...
    window.setTimeout(function() {
      ...
      window.setTimeout(function() {
        ...
        window.setTimeout(function() {
          ...
          console.warn('Ryu need your help to break the documentation!');
          ...
          $full.on('click', function(event) {
            ...
            if ($destroyingItem.length === 0) {
              ...
              if ($item.length <= 0) {
                ...
                if (_a) {
                  console.warn("Ryu still needing your help! don't stop fighting!");
                  _a = false;
                }
              }
              ...
              if ($item.length === 0) {
                ...
                window.setTimeout(function() {
                  ...
                  window.setTimeout(function() {
                    ...
                    console.clear();
                    console.log('%c Everything look better now...', 'color: #002835');
