(function() {
  console.log('%c Ryu has come to rescue you !', 'color: #002835');
  ...
  $full.one('click', function(event) {
    ...
    var $text2  = $('<p style="' +
      ...
      'line-height: 50px; ' +
      'white-space: nowrap; ' +
      'transition: margin-left 5s ease, opacity 1s ease, transform 0.25s cubic-bezier(0.68, -0.55, 0.27, 1.55); ' +
      'margin-left: 1500px; ' +
    ...
    window.setTimeout(function() {
      ...
      window.setTimeout(function() {
        ...
        $container.css('transition', 'all 1s ease');
        ...
        window.setTimeout(function() {
          ...
          console.warn('Ryu needs your help to break the documentation!');
          ...
          $full.on('click', function(event) {
            ...
            if ($destroyingItem.length === 0) {
              ...
              if ($item.length <= 0) {
                ...
                if (_a) {
                  console.warn("Ryu still needs your help! Don't stop fighting!");
                  _a = false;
                }
              }
              ...
              if ($item.length === 0) {
                ...
                window.setTimeout(function() {
                  ...
                  window.setTimeout(function() {
                    ...
                    console.clear();
                    console.log('%c The documentation looks much cleaner now...', 'color: #002835');
              ...
              $destroyingItem.css('transition', 'transform 0.2s ease, max-height 0.4s ease');
            }
            ...
            if (_b) {
              $text2.css('transform', 'scale(1.08, 1.03)');
            } else {
              $text2.css('transform', 'scale(1, 1)');
            }
