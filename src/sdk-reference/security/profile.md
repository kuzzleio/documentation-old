...
Instantiate a new [Profile]({{ site_url }}{{{ site_base_path }}}sdk-reference/profile) object.
...
Returns the new [Profile]({{ site_url }}{{{ site_base_path }}}sdk-reference/profile) object.
