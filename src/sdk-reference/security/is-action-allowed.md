...
<aside class="notice">
You can get the rights from Kuzzle by using <a href="#getUserRights">`Security.getUserRights`</a> and <a href="/sdk-reference/security/getMyRights">`Security.getMyRights`</a>.
</aside>
