...
Given an index, the `refresh` action forces a [`refresh`](https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-refresh.html),
...
<aside class="left warning">
    ...
    <br>
    From <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-refresh.html">elasticsearch documentation</a>:
    <div class="quote">
