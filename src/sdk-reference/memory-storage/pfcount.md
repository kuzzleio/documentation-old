...
Returns the probabilistic cardinality of a [HyperLogLog](https://en.wikipedia.org/wiki/HyperLogLog) data structure, or of the merged HyperLogLog structures if more than 1 is provided (see [pfadd]({{ site_url }}{{{ site_base_path }}}sdk-reference/memory-storage/pfadd)).
