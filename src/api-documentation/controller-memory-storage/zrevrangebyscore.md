...
Identical to [zrangebyscore]({{ site_url }}{{{ site_base_path }}}api-documentation/controller-memory-storage/zrangebyscore) except that the sorted set is traversed in descending order.
