...
The token itself is generated by the [Auth controller]({{ site_base_path }}api-documentation/controller-auth) login action and must be included with each request.
