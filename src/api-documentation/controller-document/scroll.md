...
This method moves forward a result set cursor created by a [`search` query]({{ site_url }}{{{ site_base_path }}}api-documentation/controller-document/search/) with the `scroll` argument provided.
