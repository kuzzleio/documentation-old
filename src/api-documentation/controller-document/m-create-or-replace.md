...
Returns a [partial error]({{ site_url }}{{{ site_base_path }}}api-documentation/errors/#partialerror) (with status 206) if one or more documents can not be created or replaced.
