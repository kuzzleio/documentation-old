...
This method moves forward a result set cursor created by a [`searchProfiles` query]({{ site_url }}{{{ site_base_path }}}api-documentation/controller-security/search-profiles) with the `scroll` argument provided.
