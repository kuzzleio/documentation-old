...
In both cases, you'll be able to <a href="{{ site_url }}{{{ site_base_path }}}guide/essentials/installing-backoffice/#select-the-kuzzle-server-to-connect-to">select the Kuzzle server</a> you want to manage once the Backoffice starts up.
...
![Kuzzle Backoffice is trying to connect to a Kuzzle server]({{ site_url }}{{{ site_base_path }}}assets/images/kuzbo-connecting.png)
...
![Kuzzle Backoffice prompts the creation of a first admin account]({{ site_url }}{{{ site_base_path }}}assets/images/kuzbo-firstadmin.png)
