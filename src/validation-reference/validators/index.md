...
The `validators` property is an array of [DSL filters]({{ site_url }}{{{ site_base_path }}}kuzzle-dsl). Each filters have to match in order for the document to be valid.
