...
The `validators` property is an array of [DSL filters](http://kuzzle.io/documentation/real-time-filters). Each filters have to match in order for the document to be valid.
