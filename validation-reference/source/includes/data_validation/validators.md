...
The `validators` property is an array of [DSL filters](http://kuzzle.io/guide/#filtering-syntax). Each filters have to match in order for the document to be valid.
