       ...
       // _setEventHandlers
                ...
                $("html, body").promise().done(function() {
                    ...
                    setTimeout(function() {
                        ...
                        if(self.options.highlightOnScroll && elem.length && !elem.hasClass(self.focusClass)) {
                            ...
                            var scrollToElem = $(elem).closest('.' + self.focusClass);
        ...
        _scrollTo: function(elem) {
            ...
            $("html, body").promise().done(function() {
                ...
                var
                  targetTagName = $('div[data-unique="' + elem.attr("data-unique") + '"]').next().find('.heading-title').parent()[0].tagName,
                  to;
                ...
                to = $('div[data-unique="' + elem.attr("data-unique") + '"]').next().offset().top;
                //to -= ($.isFunction(scrollTo) ? scrollTo.call() : scrollTo);
                to -= $('header').height();
