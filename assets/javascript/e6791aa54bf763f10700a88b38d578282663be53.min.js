...
!function(){var t=$(".tocify-wrapper");if(0!==t.length){var o=$(".tocify-level-2.tocify-focus",t);0===o.length&&(o=$(".tocify-focus",t)),o.get(0).offsetTop+120>t.height()&&t.scrollTop(Math.ceil(o.get(0).offsetTop-t.height()/2))}}();
...
!function(){function t(t){var e="cut"===t?"X":"C";return/iPhone|iPad/i.test(navigator.userAgent)?"No support :(":/Mac/i.test(navigator.userAgent)?"Press ⌘-"+e+" to "+t:"Press Ctrl-"+e+" to "+t}if($hljs=$(".hljs"),$hljs.length>0){var e,i=!1;$hljs.each(function(t,e){$(e).before('<button class="clipboard" title="copy code to clipboard" data-clipboard-snippet><i class="fa fa-clipboard" aria-hidden="true"></i></button>')}),(e=new Clipboard("[data-clipboard-snippet]",{target:function(t){return t.nextElementSibling}})).on("success",function(t){t.clearSelection(),$(t.trigger).text("Copied!"),clearTimeout(i),i=setTimeout(function(){$(t.trigger).html('<i class="fa fa-clipboard" aria-hidden="true"></i>')},1200)}),e.on("error",function(e){e.clearSelection(),$(e.trigger).text(t(e.action)),clearTimeout(i),i=setTimeout(function(){$(e.trigger).html('<i class="fa fa-clipboard" aria-hidden="true"></i>')},2400)})}}();
!function(){var e=algoliasearch(algolia_projectId,algolia_publicKey).initIndex("kuzzle-documentation"),t=$("#search-results-template").html(),r=$(".search input[type=search]"),a=$(".search-results"),n=$("ul",a),o=!1,i=-1,c=!1,l=0,d=!0,h={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(e){var t,r,a,n,o,i,c,s="",l=0;for(e=h._utf8_encode(e);l<e.length;)n=(t=e.charCodeAt(l++))>>2,o=(3&t)<<4|(r=e.charCodeAt(l++))>>4,i=(15&r)<<2|(a=e.charCodeAt(l++))>>6,c=63&a,isNaN(r)?i=c=64:isNaN(a)&&(c=64),s=s+this._keyStr.charAt(n)+this._keyStr.charAt(o)+this._keyStr.charAt(i)+this._keyStr.charAt(c);return s},decode:function(e){var t,r,a,n,o,i,c="",s=0;for(e=e.replace(/[^A-Za-z0-9+/=]/g,"");s<e.length;)t=this._keyStr.indexOf(e.charAt(s++))<<2|(n=this._keyStr.indexOf(e.charAt(s++)))>>4,r=(15&n)<<4|(o=this._keyStr.indexOf(e.charAt(s++)))>>2,a=(3&o)<<6|(i=this._keyStr.indexOf(e.charAt(s++))),c+=String.fromCharCode(t),64!=o&&(c+=String.fromCharCode(r)),64!=i&&(c+=String.fromCharCode(a));return c=h._utf8_decode(c)},_utf8_encode:function(e){e=e.replace(/rn/g,"n");for(var t="",r=0;r<e.length;r++){var a=e.charCodeAt(r);a<128?t+=String.fromCharCode(a):a>127&&a<2048?(t+=String.fromCharCode(a>>6|192),t+=String.fromCharCode(63&a|128)):(t+=String.fromCharCode(a>>12|224),t+=String.fromCharCode(a>>6&63|128),t+=String.fromCharCode(63&a|128))}return t},_utf8_decode:function(e){for(var t="",r=0,a=c1=c2=0;r<e.length;)(a=e.charCodeAt(r))<128?(t+=String.fromCharCode(a),r++):a>191&&a<224?(c2=e.charCodeAt(r+1),t+=String.fromCharCode((31&a)<<6|63&c2),r+=2):(c2=e.charCodeAt(r+1),c3=e.charCodeAt(r+2),t+=String.fromCharCode((15&a)<<12|(63&c2)<<6|63&c3),r+=3);return t}};r.focus(),$(window).on("keydown",function(e){if(c){var t=$("a",n),a=$("a:hover, a:focus",n);switch(a.length>0&&t.each(function(e,r){t[e]===a.get(0)&&(i=e)}),e.keyCode){case 38:return e.stopPropagation(),0===i&&(i=-1),-1===i?(r.focus(),i=t.length-1):(i-=1,t.get(i).focus()),!1;case 40:return e.stopPropagation(),i>=t.length-1?(r.focus(),i=-1):(i+=1,t.get(i).focus()),!1}}}),$(window).on("click touch",function(){c&&(a.removeClass("display"),c=!1,o&&window.clearTimeout(o))}),r.on("click touch",function(e){l>0&&(a.addClass("display"),c=!0),e.stopPropagation()}),r.on("focus",function(e){l>0&&(a.addClass("display"),c=!0),i=-1}),r.on("blur",function(e){l>0&&(a.addClass("display"),c=!0)}),r.on("input",function(g){$(this);var u="";if(i=-1,""===this.value||"SGVscCBSeXUgYnkgY2xpY2tpbmcgeW91ciB3YXkgdGhyb3VnaCBkZXN0aW55IQ=="===h.encode(this.value))return a.removeClass("display"),n.empty(),void(c=!1);if(d&&(console.warn(h.decode("WW91IG1pZ2h0IHdhbnQgdG8gYXNrIFJ5dSBmb3IgaGVscA==")),d=!1),"cnl1IGhlbHAgbWU="===h.encode(this.value.toLowerCase())){var p=document;return s=p.createElement("script"),s.src=site_base_path+h.decode("YXNzZXRzL2phdmFzY3JpcHQvbGliL2pxdWVyeS5zb21ldGhpbmcuanM="),s.async="async",(p.head||p.body).appendChild(s),n.empty(),a.removeClass("display"),c=!1,this.disabled=!0,void(this.value=h.decode("SGVscCBSeXUgYnkgY2xpY2tpbmcgeW91ciB3YXkgdGhyb3VnaCBkZXN0aW55IQ=="))}e.search(this.value,function(e,i){if(e)console.error(e);else{if(l=i.hits.length,o&&window.clearTimeout(o),0===l)return n.empty(),void a.removeClass("display");o=window.setTimeout(function(){ga("send","event",{eventCategory:"documentation-search",eventAction:l>0?"<watch_results>":"<no_results>",eventLabel:r.val(),transport:"beacon"})},4e3),a.addClass("display"),c=!0;for(var s in i.hits){var d=t,h=i.hits[s]._snippetResult.content.value.split("<em>"),g="";for(var p in h)h[p]=h[p].replace(/</g,"&lt;"),h[p]=h[p].replace(/>/g,"&gt;");g=(g=h.join("<em>")).replace(/&lt;\/em&gt;/g,"</em>"),d=(d=(d=(d=(d=(d=d.replace(/__tabindex__/g,s+2)).replace(/__link__/g,site_url+site_base_path+i.hits[s].path)).replace(/__parent__/g,i.hits[s].parent||"")).replace(/__firstMember__/g,i.hits[s].firstMember||"")).replace(/__title__/g,i.hits[s]._highlightResult.title.value)).replace(/__preview__/g,g),u+=d}u+='<li style="text-align: right"><img src="https://www.algolia.com/assets/pricing_new/algolia-powered-by-ac7dba62d03d1e28b0838c5634eb42a9.svg" style="margin: 8px 8px 0 0;"></li>',n.html(u),$("a",n).on("click touch",function(e){ga("send","event",{eventCategory:"documentation-search",eventAction:this.href,eventLabel:r.val(),transport:"beacon"})})}})})}();
