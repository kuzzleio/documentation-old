...
!function(e,n,o){function t(){return"function"!=typeof n.createElement?n.createElement(arguments[0]):f?n.createElementNS.call(n,"http://www.w3.org/2000/svg",arguments[0]):n.createElement.apply(n,arguments)}var s=[],a=[],i={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var o=this;setTimeout(function(){n(o[e])},0)},addTest:function(e,n,o){a.push({name:e,fn:n,options:o})},addAsyncTest:function(e){a.push({name:null,fn:e})}},l=function(){};l.prototype=i,l=new l;var r=n.documentElement,f="svg"===r.nodeName.toLowerCase(),d=i._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];i._prefixes=d;var c=i.testStyles=function(e,o,s,a){var i,l,d,c,p,u="modernizr",h=t("div"),m=((p=n.body)||((p=t(f?"svg":"body")).fake=!0),p);if(parseInt(s,10))for(;s--;)d=t("div"),d.id=a?a[s]:u+(s+1),h.appendChild(d);return(i=t("style")).type="text/css",i.id="s"+u,(m.fake?m:h).appendChild(i),m.appendChild(h),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(n.createTextNode(e)),h.id=u,m.fake&&(m.style.background="",m.style.overflow="hidden",c=r.style.overflow,r.style.overflow="hidden",r.appendChild(m)),l=o(h,e),m.fake?(m.parentNode.removeChild(m),r.style.overflow=c,r.offsetHeight):h.parentNode.removeChild(h),!!l};l.addTest("touchevents",function(){var o;if("ontouchstart"in e||e.DocumentTouch&&n instanceof DocumentTouch)o=!0;else{var t=["@media (",d.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");c(t,function(e){o=9===e.offsetTop})}return o}),function(){var e,n,o,t,i,r,f;for(var d in a)if(a.hasOwnProperty(d)){if(e=[],(n=a[d]).name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(o=0;o<n.options.aliases.length;o++)e.push(n.options.aliases[o].toLowerCase());for(t="function"==typeof n.fn?n.fn():n.fn,i=0;i<e.length;i++)r=e[i],f=r.split("."),1===f.length?l[f[0]]=t:(!l[f[0]]||l[f[0]]instanceof Boolean||(l[f[0]]=new Boolean(l[f[0]])),l[f[0]][f[1]]=t),s.push((t?"":"no-")+f.join("-"))}}(),function(e){var n=r.className,o=l._config.classPrefix||"";if(f&&(n=n.baseVal),l._config.enableJSClass){var t=new RegExp("(^|\\s)"+o+"no-js(\\s|$)");n=n.replace(t,"$1"+o+"js$2")}l._config.enableClasses&&(n+=" "+o+e.join(" "+o),f?r.className.baseVal=n:r.className=n)}(s),delete i.addTest,delete i.addAsyncTest;for(var p=0;p<l._q.length;p++)l._q[p]();e.Modernizr=l}(window,document);
